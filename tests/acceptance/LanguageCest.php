...
require_once __DIR__.'/../mocks/LangMock.php';
...
class LanguageCest
{
    ...
    {
        $I->sendGET('/lang');
        $I->seeResponseEquals(json_encode([LangMock::$data['en']]));
    }
    ...
    public function testAcceptMultipleLanguagesAndMatchFirst(AcceptanceTester $I)
    {
        ...
        $I->sendGET('/lang');
        $I->seeResponseEquals(json_encode([LangMock::$data['es']]));
    }
    ...
    public function testAcceptMultipleLanguagesAndControllerCanMatch(AcceptanceTester $I)
    {
        ...
        $I->sendGET('/lang');
        $I->seeResponseEquals(json_encode([LangMock::$data['ca']]));        
    }
